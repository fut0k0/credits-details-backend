...
a11 =  Album.create(title: "Ringleader Of The Tormentors", format: "cd", user_id: 1, year_id: 7, genre_id: 1, artist_id: 8, producer_id: 1, mixer_id: 1, engineer_id: 7)
a12 =  Album.create(title: "You Are The Quarry", format: "cd", user_id: 1, year_id: 8, genre_id: 1, artist_id: 8, producer_id: 9, mixer_id: 7, engineer_id: 8)
a13 =  Album.create(title: "Years Of Refusal", format: "cd", user_id: 1, year_id: 9, genre_id: 1, artist_id: 8, producer_id: 9, mixer_id: 2, engineer_id: 9)
a14 = Album.create(title: "Gish", format: "cd", user_id: 1, year_id: 3, genre_id: 5, artist_id: 5, producer_id: 4, mixer_id: 2, engineer_id: 1)
