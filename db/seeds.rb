...
a9 =  Album.create(title: "Mudhoney", format: "cd", user_id: 2, year_id: 4, genre_id: 4, artist_id: 6, producer_id: 7, mixer_id: 2, engineer_id: 6)
a10 =  Album.create(title: "Eternal Return", format: "cd", user_id: 2, year_id: 6, genre_id: 6, artist_id: 7, producer_id: 8, mixer_id: 6, engineer_id: 6)
